    ...
    <div class="row">
        ...
        <div class="col-md-12">
                <ul class="list-inline">
                    <li><strong>订单金额：<span class="text-danger"><?php echo ($money); ?></span>&nbsp;&nbsp;元</strong></li>
                    <li><strong>商品名称：</strong><?php echo ($params["subject"]); ?></li>
                    <li><strong>订单编号：</strong><?php echo ($params["out_trade_id"]); ?></li>
                    <li><strong>交易币种：</strong>人民币</li>
                    <li><strong>交易时间：</strong><?php echo ($params['datetime']); ?></li>
                </ul>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#alipay" aria-controls="alipay" role="tab" data-toggle="tab">支付宝支付
                </a></li>
            </ul>
				<!-- Tab panes -->
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane active" id="alipay">
                        <table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tbody><tr>
                                <td width="90" align="center">&nbsp;</td>
                                <td width="860" align="center"><table border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tbody><tr>
                                        <td align="center"><br>
                                            扫一扫付款（元）</td>
                                        <td width="250" rowspan="3" align="center" valign="top"><br>
                                            <img src="<?php echo ($url); ?>/Public/Front/img/logo-alipay.png" width="204" height="183">

                                            <br>
                                            <br>
                                            &nbsp;&nbsp;手机用户请保存图片后，用支付宝扫一扫完成支付
                                        </td>
                                    </tr>
                                    <tr align="center">
                                        <td height="20"><strong><font style="font-size:30px; color:#F60;"><?php echo ($money); ?></font>&nbsp;&nbsp;</strong></td>
                                    </tr>
                                    <tr align="center">
                                        <td><table width="100%" border="0" cellspacing="5" cellpadding="0" style="border: 1px solid #E7EAEC; ">
                                            <tbody><tr>
                                                <td>
                                                    <img src="<?php echo ($imgurl); ?>" width="230" height="230">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tbody><tr>
                                                        <td height="30" align="center"><img
                                                                src="/Public/Front/img/saoyisao.png"
                                                                width="14"
                                                                height="14"></td>
                                                        <td align="center"><font style="font-size:14px; color:#F60;"><strong>打开手机支付宝，扫一扫付款</strong></font></td>
                                                    </tr>
                                                    </tbody></table></td>
                                            </tr>
                                            </tbody></table></td>
