  ...
  <div class="col-md-12">
    <div class="ibox float-e-margins">
      ...
      <div class="ibox-content">
            ...
            <div class="layui-inline">
              <div class="layui-input-inline">
                <select name="tongdao">
                  ...
                  <?php if(is_array($banklist)): $i = 0; $__LIST__ = $banklist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($_GET[tongdao] == $vo[code]): ?>selected<?php endif; ?>
              ...
              <div class="layui-input-inline">
                <select name="ddlx">
                  ...
                  <option <?php if($_GET[ddlx] == 2): ?>selected<?php endif; ?> value="0">收款订单</option>
        ...
        <blockquote class="layui-elem-quote" style="font-size:14px;padding:8px;">成功交易总金额：<span class="label label-info"><?php echo ($sum["pay_amount"]); ?>元</span>
          商户收入金额: <span class="label label-info"><?php echo ($sum["f_amount"]); ?>元</span>

          成功总订单数：<span class="label label-info"><?php echo ($sum["success_count"]); ?></span> 失败订单数：<span class="label label-danger"><?php echo ($sum["fail_count"]); ?></span>
        ...
        <table class="layui-table" lay-data="{width:'100%',limit:<?php echo ($rows); ?>,id:'userData'}">
          ...
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td>
                <button class="layui-btn layui-btn-small" onclick="order_view('订单号:<?php echo ($vo["out_trade_id"]); ?>','<?php echo U('User/Order/show',['oid'=>$vo[id]]);?>',600,400)">查看</button>
                <button class="layui-btn layui-btn-small" onclick="order_del(this,'<?php echo ($vo["id"]); ?>')" >删除</button>
              </td>
...
<script>
    ...
    $('#export').on('click',function(){
        window.location.href
            ="<?php echo U('User/Order/exportorder',array('orderid'=>$_GET[orderid],'createtime'=>$_GET[createtime],'successtime'=>$_GET[successtime],'tongdao'=>$_GET[tongdao],'bank'=>$_GET[bank],'status'=>$_GET[status],'ddlx'=>$_GET[ddlx]));?>";
    });
