    ...
    <div class="col-lg-12">
      ...
      <form class="layui-form" action="" method="get" autocomplete="off">
        ...
        <div class="layui-form-item">
          <div class="layui-inline">
            <div class="layui-input-inline">
              <input type="text" name="invitecod" autocomplete="off" placeholder="邀请码"
                     class="layui-input" value="<?php echo ($_GET['invitecod']); ?>">
            </div>
          </div>
          <div class="layui-inline">
            <div class="layui-input-inline">
              <input type="text" name="syusername" autocomplete="off" placeholder="使用者用户名"
                     class="layui-input" value="<?php echo ($_GET['syusername']); ?>">
            </div>
          </div>
          <div class="layui-inline">
            <div class="layui-input-inline">
          ...
          <div class="layui-inline">
            ...
            <button type="button" class="layui-btn layui-btn-danger" onclick="invite_set('创建邀请码','<?php echo U('Agent/addInvite');?>',510,380)"><span class="glyphicon glyphicon-plus"></span> 添加邀请码 </button>
          </div>
        </div>
      </form>
      <table class="layui-table" lay-data="{id:'userData'}">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td><a href="#" onClick="javascript:window.open('<?php echo ($siteurl); echo U("Login/register","invitecode=".$vo["invitecode"]);?>');">注册地址</a></td>
            <td><?php echo (getusername($vo["fmusernameid"])); ?></td>
...
<script>
    ...
    function invite_del(obj, id) {
        layer.confirm('确认要删除吗？', function (index) {
            $.ajax({
                url:"<?php echo U('Agent/delInvitecode');?>",
                type:'post',
                data:'id='+id,
