...
mdi-action-cached
       ...
       <?php if(is_array($products)): $i = 0; $__LIST__ = $products;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?><div class="row margin">
            <div class="input-field col s12">
              <i class="prefix "></i>
                 <input name="pay_bankcode" onclick="register_check()"  type="radio" checked value="<?php echo ($p["id"]); ?>" />
                <span style="padding-left: 35px; "><?php echo ($p["name"]); ?></span>
            </div>
