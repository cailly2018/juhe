    ...
    <div class="col-md-12">
        <div class="ibox float-e-margins">
            ...
            <!--    <div class="ibox-content">
                    ...
                    <form id="addform" action="<?php echo U('Account/userInfo');?>?id=<?php echo ($p["id"]); ?>" method="post" enctype="multipart/form-data">
                          <a href="javascript:;"  style=" margin-top: 10px; padding-top: 10px;" id="import" class="file layui-btn layui-btn-danger">
                              <input type="file" name="file" id="file" />
                          <span class="glyphicon glyphicon-import"></span> 选择上传文件</a>
                         <input type="submit" class="layui-btn" style="margin-top: 10px;background-color: #ef0b0b;" value="确定导入">
                       </a>
                    </form>
                    <a href="./Uploads/csv/用户信息.csv">模板下载</a>
                </div>-->
            </div>
            <div class="ibox-content">
                <!--用户信息-->
                <form class="layui-form" action="" autocomplete="off" id="profile">
                    ...
                    <input type="hidden" name="authorized" value="<?php echo ($p["authorized"]); ?>">
                <!--    <div class="layui-form-item">
                        <label class="layui-form-label">上级代理：</label>
                        <div class="layui-input-block">-->
                            <input type="hidden" name="p[agentname]" lay-verify="title" autocomplete="off"
                                   placeholder="上级代理名称"  disabled="disabled"  class="layui-input"  value="<?php echo ($p["agentname"]); ?>">
                 <!--       </div>
                    </div>-->
                    <div class="layui-form-item">
                        <label class="layui-form-label">公司名称：</label>
                        <div class="layui-input-block">
                            <input type="text" name="p[pname]"  <?php if($p[authorized] == 1): ?>readonly="readonly"<?php endif; ?> lay-verify="title" autocomplete="off"
                                   placeholder="公司名称" class="layui-input" value="<?php echo ($p["pname"]); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">营业执照号：</label>
                        <div class="layui-input-block">
                            <input type="text" name="p[licence]" lay-verify="title" autocomplete="off"
                                   placeholder="营业执照号" class="layui-input" <?php if($p[authorized] == 1): ?>readonly="readonly"<?php endif; ?>  value="<?php echo ($p["licence"]); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="p[realname]" lay-verify="title" autocomplete="off"
                                   placeholder="法人姓名" class="layui-input" <?php if($p[authorized] == 1): ?>readonly="readonly"<?php endif; ?> value="<?php echo ($p["realname"]); ?>">
                        </div>
                    </div>
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="p[sfznumber]" lay-verify="identity" <?php if($p[authorized] == 1): ?>readonly="readonly"<?php endif; ?>  placeholder="身份证号码" autocomplete="off" class="layui-input" value="<?php echo ($p["sfznumber"]); ?>">
                    </div>
                </div>
                        ...
                        <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text"  lay-verify="phone" disabled autocomplete="off"
                                           class="layui-input" value="<?php echo ($p["mobile"]); ?>">
                                </div>
                                <div class="layui-input-inline">
                                    <?php if($p['mobile']): ?><a href="javascript:;" style="color:blue;" class="editMobile" data-id="<?php echo ($p["id"]); ?>">点击修改手机号</a>
                                    <?php else: ?>
                                        <a href="javascript:;" style="color:blue;" class="bindMobile" data-id="<?php echo ($p["id"]); ?>">点击绑定手机号</a><?php endif; ?>               
                                </div>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="p[qq]" lay-verify="" autocomplete="off"
                                       class="layui-input" value="<?php echo ($p["qq"]); ?>">
                            </div>
                        </div>
