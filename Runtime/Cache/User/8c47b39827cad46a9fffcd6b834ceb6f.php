    ...
    <div class="ibox float-e-margins">
      ...
      <div class="ibox-content">
        <form class="layui-form" action="" method="get" autocomplete="off" id="orderform">
          ...
          <blockquote class="layui-elem-quote" style="font-size:14px;padding:8px;">今日交易总额：<span class="label label-info"><?php echo ($stat["todaysum"]); ?>元</span>  今日交易笔数：<span class="label label-danger"><?php echo ($stat["todaysuccesscount"]); ?></span>
