...
<div class="wrapper wrapper-content animated">
      <div class="ibox-content">
        <table class="layui-table">
          ...
          <tr><td>提交地址：</td><td><?php echo ($order["pay_tjurl"]); ?></td></tr>
          <tr><td>页面返回地址：</td><td><?php echo ($order["pay_callbackurl"]); ?></td></tr>
          <tr><td>服务器通知地址：</td><td><?php echo ($order["pay_notifyurl"]); ?></td></tr>
          <tr><td>订单描述：</td><td><?php echo ($order["pay_productname"]); ?></td></tr>
          <tr><td>状态：</td><td>
            <?php switch($order[pay_status]): case "0": ?><strong class="text-danger">未处理</strong><?php break;?>
              <?php case "1": ?><strong class="text-warning">已成功，未返回[
                <?php if($order['pay_status'] == 1): ?><a href="<?php echo U('Pay/Pay/bufa', ['TransID'=>$order['pay_orderid'],'tongdao'=>$order['pay_ytongdao']]);?>" target="_blank">补发通知</a><?php endif; ?>
                ]</strong><?php break;?>
              <?php case "2": ?><strong class="text-success">已成功，已返回</strong><?php break; endswitch;?>
          </td></tr>
        </table>
      </div>
</div>
