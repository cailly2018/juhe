                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <select name="T">
                                    ...
                                    <option <?php if($_GET[T] == 1): ?>selected<?php endif; ?> value="0">T + 0</option>
...
<script>
    ...
    $('#export').on('click',function(){
        window.location.href
            ="<?php echo U('User/Withdrawal/exportweituo',array('T'=>$_GET[T],'createtime'=>$_GET[createtime],'successtime'=>$_GET[successtime],'tongdao'=>$_GET[tongdao],'status'=>$_GET[status]));?>";
    });
