...
<div class="wrapper wrapper-content animated">
			...
			<input type="hidden" name="userid" value="<?php echo ($u["id"]); ?>">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="u[parentid]" autocomplete="off"  autocomplete="off"
							   value="<?php echo ($u["parentid"]); ?>"
							   placeholder="上级商户号"
							   class="layui-input"
						>
					</div>
			  ...
			  <div class="layui-form-item">
				...
				<div class="layui-input-inline">
				  <input type="text" autocomplete="off"  value="<?php echo ($u["mobile"]); ?>"  readonly placeholder="手机号码" class="layui-input">
				</div>
			  </div>
		...
		<div class="layui-input-block">
			<textarea name="u[df_ip]" id="text"  placeholder="如：127.0.0.1，多个IP请换行，一行一个IP" class="layui-textarea"><?php echo ($u[df_ip]); ?></textarea>
		</div>
		<label class="layui-form-label"></label><div class="layui-form-mid layui-word-aux">注意：请填写发起代付请求的服务器公网IP一行一个IP地址。</div>
       </div>
       <input id="df_ipsss" type="hidden" value="<?php echo ($u[df_ip]); ?>">
       <div class="layui-form-item" style="margin-top: 50px;" id="send">
			<label class="layui-form-label">验证码：</label>
			<div class="layui-input-inline">
				<input type="text" autocomplete="off" class="layui-input" id="code" name="code" value=""  placeholder="">
			</div>
			<div class="layui-input-inline">

				<a href="javascript:;" id="sendBtn" data-bind='' class="layui-btn" >发送验证码</a>
...
<input id="send_st" name="send_st" type="hidden" value="0">
<input id="df_auto_checks" type="hidden" value="<?php echo ($u['df_auto_check']); ?>">
