                ...
                <div class="ibox-content">
                    ...
                    <table class="layui-table" lay-data="{width:'100%',limit:<?php echo ($rows); ?>,id:'userData'}">
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'money', width:250,style:'background-color: #5FB878; color: #fff;cursor: pointer;'}">账户总额</th>
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><div title="用户资金管理"
                                         onclick="member_money('商户：<?php echo ($vo["username"]); ?>','<?php echo U("User/usermoney",['userid'=>$vo["id"]]) ;?>',800,600)">可提现：<?php echo ($vo["balance"]); ?> 冻结：<?php echo ($vo["blockedbalance"]); ?></div></td>
