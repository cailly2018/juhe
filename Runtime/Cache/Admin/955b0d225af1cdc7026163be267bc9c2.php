          ...
          <tr><td>状态：</td><td>
            <?php switch($order[pay_status]): case "0": ?><strong class="text-danger">未处理</strong><?php break;?>
              <?php case "1": ?><strong class="text-warning">已成功，未返回[
                <?php if($order['pay_status'] == 1): ?><a href="<?php echo U('Pay/Pay/bufa', ['TransID'=>$order['pay_orderid'],'tongdao'=>$order['pay_ytongdao'],'buname'=>$order['bu_admin']]);?>" target="_blank">补发通知</a><?php endif; ?>
                ]</strong><?php break;?>
