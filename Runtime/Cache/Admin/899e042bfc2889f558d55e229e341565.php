...
<div class="wrapper wrapper-content animated">
        <div class="row">
			...
			<form class="layui-form" action="" id="form" autocomplete="off" >
				...
				<input type="hidden" name="channe_code" value="<?php echo ($channe_code); ?>">
				...
				<div class="layui-form-item" id="auth_sms" style="display: none">
...
layui.use(['layer', 'form','laydate'], function(){
  ...
  form.on('submit(save)', function(data){
      layer.confirm('确认要提交代付申请吗？',{
          btn: ['确定','取消'] //按钮
      }, function(){
          $.ajax({
              url:"<?php echo U('Withdrawal/submitDf');?>",
              type:"post",
              data:$('#form').serialize(),
...
<script>
    $(function (){
        var sendUrl = "<?php echo U('Withdrawal/submitDfSend');?>";
        // 手机验证码发送
