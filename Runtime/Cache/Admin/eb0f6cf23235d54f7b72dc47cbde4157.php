        ...
        <div class="list item">
          ...
          <table class="layui-table" lay-data="{width:'100%',id:'userData'}">
            ...
            <tr>
              ...
              <th lay-data="{field:'paid_order_amount',width:120}">到账金额</th>
              <th lay-data="{field:'balance',width:120}">可用资金</th>
              <th lay-data="{field:'blockedbalance',width:120}">冻结资金</th>
              <th lay-data="{field:'pay_amount',width:120}">入金总额</th>
              <th lay-data="{field:'tkmoney',width:120}">出金总额</th>
              <th lay-data="{field:'sxfmoney',width:120}">出金手续费</th>
              <th lay-data="{field:'platform_income',width:120}">充值手续费</th>
              <th lay-data="{field:'money',width:120}">实际出金金额</th>
              <th lay-data="{field:'member_income',width:120}">商户收入</th>
              <th lay-data="{field:'platform_income',width:120}">平台收入</th>
     ...
     <!--          <th lay-data="{field:'lx3',width:115}">手动增加余额</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo ($stat["pay_amount"]); ?>元</td>
