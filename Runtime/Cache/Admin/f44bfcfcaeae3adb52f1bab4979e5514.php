            ...
            <div class="ibox-content">
                <form class="layui-form" action="" autocomplete="off" id="baseForm">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="smtp_user" value="<?php echo ($vo["smtp_user"]); ?>" placeholder="例如：zhifu@quefu.cn" lay-verify="email" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="password" name="smtp_pass" value="<?php echo ($vo["smtp_pass"]); ?>"  placeholder="QQ邮箱，请填写授权码"
                ...
                <div class="layui-form-item" style="margin-top: 50px;">
                    ...
                    <div class="layui-input-inline">
                        <input type="email" autocomplete="off" class="layui-input" id="cs_text" name="cs_text" value=""  placeholder="例如：info@baidu.com">
                    </div>
                    <div class="layui-input-inline">
                        <button class="layui-btn" lay-submit="" onclick="sendEmail()">测试发送邮件</button>
                    </div>
                </div>
            </div>
        </div>
