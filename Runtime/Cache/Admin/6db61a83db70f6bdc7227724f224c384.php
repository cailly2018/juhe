    ...
    <form class="layui-form" action="" id="profile">
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
          <input type="text" name="u[password]" autocomplete="off" value="" placeholder="修改登录密码" class="layui-input">
        </div>
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
          <input type="text" name="u[paypassword]" lay-verify="" autocomplete="off" value="" placeholder="修改支付密码" class="layui-input">
        </div>
        <div class="layui-form-mid layui-word-aux">不修改密码，请留空.</div>
      </div>
      <div class="layui-form-item">
