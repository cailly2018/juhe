                        ...
                        <div class="layui-inline">
                            <div class="layui-input-inline">
                                <select name="tongdao">
                                    ...
                                    <?php if(is_array($banklist)): $i = 0; $__LIST__ = $banklist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($_GET[tongdao] == $vo[id]): ?>selected<?php endif; ?>
                            ...
                            <div class="layui-input-inline">
                                <select name="bank">
                                    ...
                                    <option <?php if($_GET[bank] == 10): ?>selected<?php endif; ?> value="10">委托结算</option>
                                    <option <?php if($_GET[bank] == 11): ?>selected<?php endif; ?> value="11">提款驳回</option>
                                    <option <?php if($_GET[bank] == 12): ?>selected<?php endif; ?> value="12">代付驳回</option>
                                    ...
                                    <option <?php if($_GET[bank] == 13): ?>selected<?php endif; ?> value="13">投诉保证金解冻</option>
                                    <option <?php if($_GET[bank] == 88): ?>selected<?php endif; ?> value="88">平台收入</option>
                                </select>
                            </div>
...
<script>
    ...
    $('#export').on('click',function(){
        window.location.href
            ="<?php echo U('Admin/Order/exceldownload',array('memberid'=>$_GET[memberid],'orderid'=>$_GET[orderid],'createtime'=>$_GET[createtime],'tongdao'=>$_GET[tongdao],'bank'=>$_GET[bank]));?>";
    });
