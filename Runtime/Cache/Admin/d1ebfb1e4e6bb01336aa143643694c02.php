    ...
    <div class="wrapper wrapper-content animated">
        <div class="row">
			...
			<form class="layui-form" action="" id="payaccess">
				...
				<div class="layui-form-item">
					<label class="layui-form-label">余额查询地址：</label>
					<div class="layui-input-block">
						<input type="text" name="query_gateway_money" value="<?php echo ($list["query_gateway_money"]); ?>" autocomplete="off" class="layui-input">
					</div>
				</div>
