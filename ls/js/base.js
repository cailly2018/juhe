...
define('components/jquery/jquery', function(require, exports, module) {
...
define('modules/lib/ysbbase', function(require, exports, module) {

  /*!
   * uiframework v3.3.7 (#)
   * Copyright 2011-2016 YSB, Inc.
   * Licensed under the MIT license
   */
  
  if (typeof jQuery === 'undefined') {
    throw new Error('uiframework\'s JavaScript requires jQuery')
  }
  ...
  +function ($) {
    ...
    if ((version[0] < 2 && version[1] < 9) || (version[0] == 1 && version[1] == 9 && version[2] < 1) || (version[0] > 3)) {
      throw new Error('uiframework\'s JavaScript requires jQuery version 1.9.1 or higher, but lower than version 4')
    }
  }(jQuery);
