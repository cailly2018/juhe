...
class RRPayWXController extends PayController{
    ...
    public function Pay($array){
        ...
        if($return['pay_memberid'] ==10112 || $return['pay_memberid'] == '10112'){
            ...
            echo json_encode(array('code'=>0, 'msg'=>'调起成功', 'payurl'=> $result));die;
        }
        ...
        if($result['result'] == 0){
           ...
           //支付完成的逻辑, 反悔了一个html文本，直接在界面上将这个html文本渲染即可
            ...
            if($return['pay_memberid'] ==10112 || $return['pay_memberid'] == '10112'){
                ...
                echo json_encode(array('code'=>0, 'msg'=>'调起成功', 'payurl'=> $result ['param']));die;
            }
