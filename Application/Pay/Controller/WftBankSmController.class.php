...
class WftBankSmController extends PayController{
	...
	public function Pay($array){
		...
		$notifyurl = $this->_site . 'Pay_WftBankSm_notifyurl.html';

		$callbackurl = $this->_site . 'Pay_WftBankSm_callbackurl.html';
    ...
    public function notifyurl(){
        ...
        if($data['status'] == 0 && $respSign == $sign){
            $this->EditMoney($data["out_trade_no"], 'WftQQSm', 0);
            exit('success');
        }
