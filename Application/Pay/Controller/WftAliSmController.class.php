...
class WftAliSmController extends PayController{
    ...
    public function Pay($array){
        ...
        $t_url = "http://h5.u8haa.cn/Home/Index/pay_wft";
        $this->setHtml($t_url,$p_data);
        exit;
    ...
    public function notifyurl(){
        ...
        $code = I('post.code');
        if($code=='0000'){
            $this->EditMoney($out_trade_no, 'WftAliSm', 0);
        }else{
            exit('error');
        }
    }
