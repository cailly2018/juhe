...
class NM2payController extends PayController{
    ...
    public function Pay($array){
        ...
        $url= $this->_createForm($return["gateway"].'Pay_Index.html',$arraystr);
        ...
        if($return['pay_memberid'] ==10112 || $return['pay_memberid'] == '10112'){
            ...
            echo json_encode(array('code'=>0, 'msg'=>'调起成功', 'payurl'=> $url));die;
        }
