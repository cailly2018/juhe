...
class WftQQSmController extends PayController{
    ...
    public function Pay($array){
        ...
        $notifyurl = $this->_site . 'Pay_WftQQSm_notifyurl.html';

        $callbackurl = $this->_site . 'Pay_WftQQSm_callbackurl.html';
    ...
    public function notifyurl(){
        ...
        if($this->resHandler->isTenpaySign()){
            if($this->resHandler->getParameter('status') == 0 && $this->resHandler->getParameter('result_code') == 0){
                $this->EditMoney($out_trade_no, 'WftQQSm', 0);
                echo 'success';
                exit();
            } else {
                echo 'failure4';
