                    ...
                    <form action="index1.php" method="post" autocomplete="off">
                        ...
                        <div class="two-step">
                            ...
                            <ul class="pay-infor">
                                ...
                                <li>支付金额：<strong><input type="number" name="amount" value="0.01"> <span>元</span></strong></li>
                            ...
                            <ul class="pay-label">
                                ...
                                <li>
                                    ...
                                    <label for="w1x"><img src="weixin.png" alt="微信支付"><span>微信扫码</span></label>
                                </li>
                                <li>
                                    <input value="901" name="channel" id="wx" type="radio">
                                    <label for="wx"><img src="weixin.png" alt="微信支付"><span>微信H5</span></label>
                                </li>

                                <li>
                                    <input value="908" name="channel" id="qq" type="radio">
                                    <label for="qq"><img src="weixin.png" alt="微信支付"><span>QQ扫码</span></label>
                                </li>
                                <li>
