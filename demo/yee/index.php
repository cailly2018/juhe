                        ...
                        <div class="two-step">
							...
							<!--
                               <li>
								 ...
								 <li>
                                    <input value="902" name="channel" id="w1x" type="radio">
                                    <label for="w1x"><img src="weixin.png" alt="微信扫码"><span>微信扫码</span></label>
                                </li>
			
                                <li>
                                    <input value="908" name="channel" id="qq" type="radio">
                                    <label for="qq"><img src="qq.png" alt="QQ扫码"><span>QQ扫码</span></label>
                                </li>
								<li>
                                    <input value="901" name="channel" id="wx" type="radio">
                                    <label for="wx"><img src="weixin.png" alt="微信公众号支付"><span>微信公众号支付</span></label>
                                </li>
								<li>
                                    <input value="904"  name="channel" id="zfb1" type="radio">
                                    <label for="zfb1"><img src="zhifubao.png" alt="支付宝服务窗支付"><span>支付宝服务窗</span></label>
                                </li> 
								
                                <li>
                                    <input value="905" name="channel" id="qq1" type="radio">
                                    <label for="qq1"><img src="weixin.png" alt="微信支付"><span>QQH5</span></label>
                                </li>
                               ...
                               <li>
                                    <input value="911" checked="checked" name="channel" id="zfb" type="radio">
                                    <label for="zfb"><img src="zhifubao.png" alt="支付宝"><span>支付宝扫码</span></label>
                                </li> 
                                <li>
								...
								-->
                                 <li>
                                    <input value="907" checked="checked"  name="channel" id="bd" type="radio">
