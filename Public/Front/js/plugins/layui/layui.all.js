...
function(e) {
    ...
    n.prototype.use = function(e, n, l) {
        ...
        var f = e[0],
        m = 0;
        if (l = l || [], o.host = o.host || (p.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0], 0 === e.length || layui["layui.all"] && u[f] || !layui["layui.all"] && layui["layui.mobile"] && u[f]) return c(),
        y;
        if (o.modules[f]) !
        function g() {
    ...
    n.prototype.router = function(e) {
        ...
        function(e, t) { / ^\w += /.test(t)?function(){t=t.split("="),o.search[t[0]]=t[1]}():o.path.push(t)}),o):o},n.prototype.data=function(t,o){if(t=t||"layui",e.JSON&&e.JSON.parse){if(null===o)return delete localStorage[t];o="object"==typeof o?o:{key:o};try{var n=JSON.parse(localStorage[t])}catch(r){var n={}}return o.value&&(n[o.key]=o.value),o.remove&&delete n[o.key],localStorage[t]=JSON.stringify(n),o.key?n[o.key]:n}},n.prototype.device=function(t){var o=navigator.userAgent.toLowerCase(),n=function(e){var t=new RegExp(e+"/ ([ ^ \\s\\_\\ - ] + )");return e=(o.match(t)||[])[1],e||!1},r={os:function(){return/windows/.test(o)?"windows ":/linux/.test(o)?"linux ":/iphone|ipod|ipad|ios/.test(o)?"ios ":/mac/.test(o)?"mac ":void 0}(),ie:function(){return!!(e.ActiveXObject||"ActiveXObject "in e)&&((o.match(/msie\s(\d+)/)||[])[1]||"11 ")}(),weixin:n("micromessenger ")};return t&&!r[t]&&(r[t]=n(t)),r.android=/android/.test(o),r.ios="ios "===r.os,r},n.prototype.hint=function(){return{error:a}},n.prototype.each=function(e,t){var o,n=this;if("
            function "!=typeof t)return n;if(e=e||[],e.constructor===Object){for(o in e)if(t.call(e[o],o,e[o]))break}else for(o=0;o<e.length&&!t.call(e[o],o,e[o]);o++);return n},n.prototype.sort=function(e,t,o){var n=JSON.parse(JSON.stringify(e));return t?(n.sort(function(e,o){var n=/^\d+$/,r=e[t],a=o[t];return n.test(r)&&(r=parseFloat(r)),n.test(a)&&(a=parseFloat(a)),r&&!a?1:!r&&a?-1:r>a?1:r<a?-1:0}),o&&n.reverse(),n):n},n.prototype.stope=function(t){t=t||e.event,t.stopPropagation?t.stopPropagation():t.cancelBubble=!0},n.prototype.onevent=function(e,t,n){return"string "!=typeof e||"
            function "!=typeof n?this:(o.event[e+"."+t]=[n],this)},n.prototype.event=function(e,t,n){var r=this,a=null,i=t.match(/\(.*\)$/)||[],u=(t=e+"."+t).replace(i,""),l=function(e,t){var o=t&&t.call(r,n);o===!1&&null===a&&(a=!1)};return layui.each(o.event[u],l),i[0]&&layui.each(o.event[t],l),a},e.layui=new n}(window);layui.define(function(a){var i=layui.cache;layui.config({dir:i.dir.replace(/lay\/dest\/$/,"")}),a("layui.all ",layui.v)});layui.define(function(e){"use strict ";var r={open:" {
                {
                    ",close:"
                }
            }
            "},n={exp:function(e){return new RegExp(e,"g ")},query:function(e,n,t){var o=["# ([\\s\\S]) + ?"," ([ ^ {#
            }]) * ?"][e||0];return c((n||"")+r.open+o+r.close+(t||""))},escape:function(e){return String(e||"").replace(/&(?!#?[a-zA-Z0-9]+;)/g," & amp;
            ").replace(/</g," & lt;
            ").replace(/>/g," & gt;
            ").replace(/'/g," & #39;
            ").replace(/" / g,
...
function() {
    ...
    D.prototype.init = function() {
        ...
        t.elem = T(t.elem),
        t.eventElem = T(t.eventElem),
        t.elem[0] && (t.range === !0 && (t.range = "-"), t.format === i.date && (t.format = i[t.type]), e.format = t.format.match(new RegExp(n + "|.", "g")) || [], e.EXP_IF = "", e.EXP_SPLIT = "", T.each(e.format,
        function(t, a) {
            var i = new RegExp(n).test(a) ? "\\b\\d{1," +
            function() {
                return /yyyy/.test(a) ? 4 : /y/.test(a) ? 308 : 2
            } () + "}\\b": "\\" + a;
            e.EXP_IF = e.EXP_IF + i,
            e.EXP_SPLIT = e.EXP_SPLIT + (e.EXP_SPLIT ? "|": "") + "(" + i + ")"
        }), e.EXP_IF = new RegExp("^" + (t.range ? e.EXP_IF + "\\s\\" + t.range + "\\s" + e.EXP_IF: e.EXP_IF) + "$"), e.EXP_SPLIT = new RegExp(e.EXP_SPLIT, "g"), e.isInput(t.elem[0]) || "focus" === t.trigger && (t.trigger = "click"), t.elem.attr("lay-key") || (t.elem.attr("lay-key", e.index), t.eventElem.attr("lay-key", e.index)), t.mark = T.extend({},
    ...
    D.prototype.render = function() {
        ...
        if (t.zIndex && (i.style.zIndex = t.zIndex), T.each(new Array(2),
        function(e) {
        ...
        function(e, t) {
            ...
            "styleSheet" in c ? (c.setAttribute("type", "text/css"), c.styleSheet.cssText = m) : c.innerHTML = m,
            T(i).addClass("laydate-theme-molv"),
            i.appendChild(c)
        }
        e.remove(),
        ...
        e.changeEvent(),
        D.thisElem = e.elemID,
        "function" == typeof t.ready && t.ready(T.extend({},
        t.dateTime, {
    ...
    D.prototype.checkDate = function(e) {
        ...
        return "limit" === e ? (c(o), i) : (l = l || r.value, "string" == typeof l && (l = l.replace(/\s+/g, " ").replace(/^\s|\s$/g, "")), i.startState && !i.endState && (delete i.startState, i.endState = !0), "string" == typeof l && l ? i.EXP_IF.test(l) ? r.range ? (l = l.split(" " + r.range + " "), i.startDate = i.startDate || i.systemDate(), i.endDate = i.endDate || i.systemDate(), r.dateTime = T.extend({},
        i.startDate), T.each([i.startDate, i.endDate],
        function(e, t) {
            m(t, l[e], e)
    ...
    D.prototype.calendar = function(e) {
        ...
        if (l.year < d[0] && (l.year = d[0], r.hint("最低只能支持到公元" + d[0] + "年")), l.year > d[1] && (l.year = d[1], r.hint("最高只能支持到公元" + d[1] + "年")), r.firstDate || (r.firstDate = T.extend({},
        l)), c.setFullYear(l.year, l.month, 1), t = c.getDay(), a = n.getEndDate(l.month, l.year), i = n.getEndDate(l.month + 1, l.year), T.each(y,
        function(e, n) {
        ...
        e && (r.listYM = [[r.startDate.year, r.startDate.month + 1], [r.endDate.year, r.endDate.month + 1]], r.list(s.type, 0).list(s.type, 1), "time" === s.type ? r.setBtnStatus("时间", T.extend({},
        r.systemDate(), r.startTime), T.extend({},
        ...
        return s.range || r.limit(T(r.footer).find(p), null, 0, ["hours", "minutes", "seconds"]),
    ...
    D.prototype.list = function(e, t) {
        ...
        } else if ("month" === e) T.each(new Array(12),
        function(e) {
            var i = T.elem("li", {
                "lay-ym": e
            }),
            ...
            e + 1 == w[1] && T(i).addClass(o),
            i.innerHTML = r.month[e] + (f ? "月": ""),
            d.appendChild(i),
            w[0] < n.firstDate.year ? s.date = a.min.date: w[0] > n.firstDate.year && (s.date = a.max.date),
            n.limit(T(i), s, t)
        }),
        ...
        if (y && h.removeChild(y), h.appendChild(d), "year" === e || "month" === e) T(n.elemMain[t]).addClass("laydate-ym-show"),
        T(d).find("li").on("click",
        function() {
            ...
            if (!T(this).hasClass(s)) {
                ...
                "year" === a.type || "month" === a.type ? (T(d).find("." + o).removeClass(o), T(this).addClass(o), "month" === a.type && "year" === e && (n.listYM[t][0] = r, l && (n[["startDate", "endDate"][t]].year = r), n.list("month", t))) : (n.checkDate("limit").calendar(), n.closeList()),
                n.setBtnStatus(),
                a.range || n.done(null, "change"),
                T(n.footer).find(v).removeClass(s)
            }
        });
        else {
            var S = T.elem("span", {
            ...
            k = function() {
                T(d).find("ol").each(function(e) {
                    var t = this,
                    a = T(t).find("li");
                    t.scrollTop = 30 * (n[C][x[e]] - 2),
                    t.scrollTop <= 0 && a.each(function(e, n) {
                        if (!T(this).hasClass(s)) return t.scrollTop = 30 * (e - 2),
                        !0
                    })
                })
            },
            ...
            T(n.elemMain[t]).addClass("laydate-time-show"),
            H[0] && H.remove(),
            m[2].appendChild(S),
            T(d).find("ol").each(function(e) {
                var t = this;
                T(t).find("li").on("click",
                function() {
                    var r = 0 | this.innerHTML;
                    T(this).hasClass(s) || (a.range ? n[C][x[e]] = r: i[x[e]] = r, T(t).find("." + o).removeClass(o), T(this).addClass(o), n.setBtnStatus(null, T.extend({},
                    n.systemDate(), n.startTime), T.extend({},
                    n.systemDate(), n.endTime)), E(), k(), (n.endDate || "time" === a.type) && n.done(null, "change"))
                })
            })
        }
        return n
    ...
    D.prototype.closeList = function() {
        ...
        T.each(e.elemCont,
        function(t, n) {
            T(this).find("." + c).remove(),
            T(e.elemMain[t]).removeClass("laydate-ym-show laydate-time-show")
        }),
    ...
    D.prototype.parse = function(e) {
        ...
        n = t.config,
        a = e ? T.extend({},
        t.endDate, t.endTime) : n.range ? T.extend({},
        t.startDate, t.startTime) : n.dateTime,
        i = t.format.concat();
        return T.each(i,
        function(e, t) { / yyyy | y / .test(t) ? i[e] = T.digit(a.year, t.length) : /MM|M/.test(t) ? i[e] = T.digit(a.month + 1, t.length) : /dd|d/.test(t) ? i[e] = T.digit(a.date, t.length) : /HH|H/.test(t) ? i[e] = T.digit(a.hours, t.length) : /mm|m/.test(t) ? i[e] = T.digit(a.minutes, t.length) : /ss|s/.test(t) && (i[e] = T.digit(a.seconds, t.length))
        }),
    ...
    D.prototype.setValue = function(e) {
        ...
        return "static" === n.position || T(a)[i](e || ""),
        this
    },
    D.prototype.stampRange = function() {
        ...
        function(a, i) {
            ...
            T(i).removeClass(m + " " + o),
            s !== e && s !== t || T(i).addClass(T(i).hasClass(h) || T(i).hasClass(y) ? m: o),
            s > e && s < t && T(i).addClass(m)
        })
    },
    D.prototype.done = function(e, t) {
        ...
        a = n.config,
        i = T.extend({},
        n.startDate ? T.extend(n.startDate, n.startTime) : a.dateTime),
        r = T.extend({},
        T.extend(n.endDate, n.endTime));
        return T.each([i, r],
        function(e, t) {
    ...
    D.prototype.choose = function(e) {
        ...
        l = function(e) {
            new Date;
            e && T.extend(a, r),
            n.range && (t.startDate ? T.extend(t.startDate, r) : t.startDate = T.extend({},
        ...
        !e.hasClass(s)) if (n.range) {
            ...
            e.addClass(o);
                ...
                if (e.addClass(o), t.endDate ? T.extend(t.endDate, r) : t.endDate = T.extend({},
    ...
    D.prototype.tool = function(e, t) {
        ...
        o = {
            ...
            date: function() {
                n.closeList(),
                T(e).attr("lay-type", "datetime").html(n.lang().timeTips)
            },
            clear: function() {
                n.setValue("").remove(),
                r && (T.extend(i, n.firstDate), n.calendar()),
    ...
    D.prototype.events = function() {
        ...
        t.elem[0] && !t.elem[0].eventHandler && (n(t.elem, "bind"), n(t.eventElem), T(document).on("click",
        function(n) {
...
function(e) {
    ...
    p.prototype.initIE = function() {
        ...
        t.elem.next().hasClass(s) || (e.elemFile.wrap(a), t.elem.next("." + s).append(function() {
            var e = [];
    ...
    p.prototype.upload = function(e, t) {
        ...
        r = o.elemFile[0],
        u = function() {
            layui.each(e || o.files || o.chooseFiles || r.files,
            function(e, t) {
                var n = new FormData;
                n.append(l.field, t),
                layui.each(l.data,
        ...
        case "file":
            if (v && !RegExp("\\w\\.(" + v + ")$", "i").test(escape(h))) return o.msg("选择的文件中包含不支持的格式"),
            r.value = "";
            break;
        case "video":
            if (!RegExp("\\w\\.(" + (v || "avi|mp4|wma|rmvb|rm|flash|3gp|flv") + ")$", "i").test(escape(h))) return o.msg("选择的视频中包含不支持的格式"),
            r.value = "";
            break;
        case "audio":
            if (!RegExp("\\w\\.(" + (v || "mp3|wav|mid") + ")$", "i").test(escape(h))) return o.msg("选择的音频中包含不支持的格式"),
            r.value = "";
            break;
        default:
            if (layui.each(h,
        ...
        return l.size > 0 && !(a.ie && a.ie < 10) ? layui.each(o.chooseFiles,
        function(e, i) {
        ...
        d = {
            select: function() {
                ...
                f.each(function(e, l) {
                    ...
                    m = i(['<div class="layui-unselect ' + a + (o ? " layui-select-disabled": "") + '">', '<div class="' + n + '"><input type="text" placeholder="' + p + '" value="' + (d ? f.html() : "") + '" ' + (v ? "": "readonly") + ' class="layui-input layui-unselect' + (o ? " " + c: "") + '">', '<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (s.find("optgroup")[0] ? " layui-select-group": "") + '">' +
                    function(e) {
                        var i = [];
                        return layui.each(e,
                        function(e, a) {
...
function(e) {
    ...
    m = ".layui-table-main",
    v = ".layui-table-fixed",
    g = ".layui-table-fixed-l",
    x = ".layui-table-fixed-r",
    b = ".layui-table-tool",
    k = ".layui-table-sort",
    C = "layui-table-edit",
    w = "layui-table-hover",
    ...
    F = ['<div class="layui-form layui-border-box {{d.VIEW_CLASS}}" lay-filter="LAY-table-{{d.index}}" style="{{# if(d.data.width){ }}width:{{d.data.width}}px;{{# } }} {{# if(d.data.height){ }}height:{{d.data.height}}px;{{# } }}">', "{{# var fixed, right; }}", '<div class="layui-table-header">', z(), "</div>", '<div class="layui-table-body layui-table-main">', N, "</div>", '{{# if(fixed && fixed !== "right"){ }}', '<div class="layui-table-fixed layui-table-fixed-l">', '<div class="layui-table-header">', z({
        fixed: !0
    }), "</div>", '<div class="layui-table-body">', N, "</div>", "</div>", "{{# }; }}", "{{# if(right){ }}", '<div class="layui-table-fixed layui-table-fixed-r">', '<div class="layui-table-header">', z({
        fixed: "right"
    }), '<div class="layui-table-mend"></div>', "</div>", '<div class="layui-table-body">', N, "</div>", "</div>", "{{# }; }}", "{{# if(d.data.page){ }}", '<div class="layui-table-tool">', '<div class="layui-inline layui-table-page" id="layui-table-page{{d.index}}"></div>', "</div>", "{{# } }}", "<style>", "{{# layui.each(d.data.cols, function(i1, item1){", "layui.each(item1, function(i2, item2){ }}", ".laytable-cell-{{d.index}}-{{item2.field||i2}}{ width:{{item2.width||50}}px }", "{{# });", "}); }}", "</style>", "</div>"].join(""),
    T = t(window),
    A = t(document),
    H = function(e) {
        var i = this;
    ...
    H.prototype.render = function(e) {
        var a, l = this;
        if (e && (l.config = e), a = l.config, a.elem = t(a.elem), a.where = a.where || {},
        a.request = t.extend({
            pageName: "page",
            limitName: "limit"
        },
        ...
        r[0] && r.remove(),
        n.after(o),
        l.layHeader = o.find(y),
        l.layMain = o.find(m),
        l.layBody = o.find(p),
        l.layFixed = o.find(v),
        l.layFixLeft = o.find(g),
        l.layFixRight = o.find(x),
        l.layTool = o.find(b),
        a.height && l.fullSize(),
        l.pullData(1),
        l.events()
    ...
    H.prototype.pullData = function(e, i) {
        ...
        if (n.url) {
            ...
            t.ajax({
                ...
                error: function(e, t) {
                    a.layMain.html('<div class="layui-none">数据接口请求异常</div>'),
                    a.renderForm(),
                    i && l.close(i)
                }
            })
            ...
            var c = {},
            s = e * n.limit - n.limit;
            c[o.dataName] = n.data.concat().splice(s, n.limit),
            c[o.countName] = n.data.length,
            a.renderData(c, e, n.data.length),
            "function" == typeof n.done && n.done(c, e, c[o.countName])
        }
    },
    H.prototype.page = 1,
    ...
    H.prototype.renderData = function(e, l, n, r) {
        var o = this,
        c = o.config,
        s = e[c.response.dataName] || [],
        u = [],
        f = [],
        h = [],
        y = function() {
            return ! r && o.sortKey ? o.sort(o.sortKey.field, o.sortKey.sort, !0) : (layui.each(s,
            function(e, a) {
                var l = [],
                n = [],
                s = [];
                0 !== a.length && (r || (a[d.config.indexName] = e), o.eachCols(function(e, r) {
                    ...
                    if (void 0 !== o && null !== o || (o = ""), !(r.colspan > 1)) {
                        var u = ['<td data-field="' + (r.field || e) + '"' +
                        function() {
                            var e = [];
                            return r.edit && e.push(' data-edit="true"'),
                            r.align && e.push(' align="' + r.align + '"'),
                            r.templet && e.push(' data-content="' + o + '"'),
                        ...
                        function() {
                            return r.checkbox ? '<input type="checkbox" name="layTableCheckbox" lay-skin="primary" ' +
                            function() {
                        ...
                        l.push(u),
                        r.fixed && "right" !== r.fixed && n.push(u),
                        "right" === r.fixed && s.push(u)
                    }
        ...
        return o.key = c.id || c.index,
        d.cache[o.key] = s,
        r ? y() : 0 === s.length ? (o.renderForm(), o.layFixed.remove(), o.layMain.html('<div class="layui-none">无数据</div>')) : (y(), void(c.page && (o.page = l, o.count = n, a.render({
    ...
    H.prototype.sort = function(e, i, a, n) {
        ...
        try {
            var o = o || e.data("field");
            if (u.sortKey && !a && o === u.sortKey.field && i === u.sortKey.sort) return;
            var p = u.layHeader.find("th .laytable-cell-" + f.index + "-" + o).find(k);
            u.layHeader.find("th").find(k).removeAttr("lay-sort"),
        ...
        "asc" === i ? c = layui.sort(y, o) : "desc" === i ? c = layui.sort(y, o, !0) : (c = layui.sort(y, d.config.indexName), delete u.sortKey),
        u.renderData({
            data: c
        },
        u.page, u.count, !0),
        l.close(u.tipsIndex),
        n && layui.event.call(e, s, "sort(" + h + ")", {
            field: o,
            type: i
        })
    },
    ...
    H.prototype.events = function() {
        ...
        function(e) {
            if (c.allowResize) {
                ...
                function(e) {
                    c.rule = e,
                    c.ruleWidth = parseFloat(e.style.width)
                })
            }
        }),
        A.on("mousemove",
        ...
        function() {
            ...
            n = l.find(k),
            r = n.attr("lay-sort");
            return n[0] && 1 !== e ? (i = "asc" === r ? "desc": "desc" === r ? null: "asc", void a.sort(l, i, null, !0)) : e = 2
        ...
        function() {
            ...
            n = e[0].checked,
            r = "layTableAllChoose" === e.attr("lay-filter");
            r ? (i.each(function(e, t) {
                t.checked = n,
                a.setCheckData(e, n)
            }), a.syncCheckAll(), a.renderForm()) : (a.setCheckData(l, n), a.syncCheckAll()),
        ...
        function() {
            ...
            r = d.cache[a.key][n];
            r[l] = i,
            layui.event.call(this, s, "edit(" + h + ")", {
                value: i,
                data: r,
                field: l
            })
        ...
        function() {
            ...
            l.siblings(f).html(e ? i(t(e).html() || this.value).render(o) : this.value),
        ...
        function() {
            ...
            if (!e.data("off")) {
                if (e.data("edit")) {
                    ...
                    return r[0].value = e.data("content") || i.text(),
                    e.find("." + C)[0] || e.append(r),
                    r.focus()
                }
    ...
    d.reload = function(e, i) {
        var a = c.config[e];
        return a ? d.render(t.extend({},
        a, i)) : r.error("The ID option was not found in the table instance")
    },
    d.render = function(e) {
        var t = new H(e);
        return c.call(t)
...
function(e) {
    ...
    m.prototype.render = function() {
        ...
        n = e.config;
        n.elem = i(n.elem),
        n.elem[0] && (e.elemItem = n.elem.find(o), n.index < 0 && (n.index = 0), n.index >= e.elemItem.length && (n.index = e.elemItem.length - 1), n.interval < 800 && (n.interval = 800), n.full ? n.elem.css({
            position: "fixed",
            width: "100%",
            height: "100%",
            zIndex: 9999
    ...
    m.prototype.slide = function(e, i) {
        ...
        n.haveSlide || ("sub" === e ? (n.subIndex(i), setTimeout(function() {
            o.eq(u.index).addClass(d),
            setTimeout(function() {
                o.eq(c).addClass(r),
                o.eq(u.index).addClass(r)
            },
            50)
        },
        50)) : (n.addIndex(i), setTimeout(function() {
            o.eq(u.index).addClass(s),
            setTimeout(function() {
                o.eq(c).addClass(l),
                o.eq(u.index).addClass(l)
            },
            50)
        },
        50)), setTimeout(function() {
            o.removeClass(a + " " + d + " " + s + " " + l + " " + r),
            o.eq(u.index).addClass(a),
            n.haveSlide = !1
        },
...
function(e) {
    ...
    t = {
        fixbar: function(e) {
            ...
            o("." + i)[0] || ("object" == typeof e.css && u.css(e.css), c.append(u), b(), u.find("li").on("click",
            function() {
                var t = o(this),
                a = t.attr("lay-type");
